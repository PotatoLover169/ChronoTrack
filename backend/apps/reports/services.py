...
def get_organization_report(
    *,
    ...
    This report is intended for Admin users and includes
    completed time entries across all projects and
    ...
    User = TimeEntry._meta.get_field(
        "owner"
    ).remote_field.model
    ...
    # ------------------------------------------------------
    # Organization project statistics
    # ------------------------------------------------------
